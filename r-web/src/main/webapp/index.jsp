...
<head>
	...
	<meta name="description" content="Administración DDHH mujeres Afrocolombianas">
        	...
        	<div class="container">
	   	    		...
	   	    		<div class="col-sm-12">
	   	    		    <div class="banner-block">
	   	    			    <div class="flex_text text-slider">
	                            <ul class="slides">
	                                <li><h2>PROTECCIÓN Y AMOR</h2></li>
	                                <li><h2>PROTEGER MUJERES</h2></li>
	                                <li><h2>AYUDA</h2></li>
	                                <li><h2>ALZA TU VOZ</h2></li>
	                            </ul>
	                        </div><!--/.text-slider-->
	                        <p>PARA LA NO VIOLENCIA Y EXPLOTACIÓN </p>
	   	    		    </div><!-- /.banner-block -->
	   	    		</div>
	   	    	</div>
	   	    </div>
	   	    <div class="recent-cause">
	   	    	<div class="container">
	   	    		<div class="row">
	   	    			<div class="col-sm-6">
	   	    				<span class="most-recent">MUASOFT: Software de apoyo para la admón de</span>
	   	    				<h3>DDHH mujeres afrocolombianas</h3>
	   	    			</div>
	   	    			<div class="col-sm-6">
	   	    				<div class="promo">
			   	   				<a href="http://www.rutapacifica.org.co/" class="btn default-btn light-blue" target="_blank">Web Ruta Pacífica</a> 
    ...
    <script>			
	  ...
	  var styledMap = new google.maps.StyledMapType(styles,
		...
		var beaches = [
		  ...
		  ['Sede Chocó', 5.685553, -76.660704, 1],
		];
